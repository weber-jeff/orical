...
from backend.astrology.core_astrology.utils import local_to_utc
from backend.astrology.astro_data.load_meanings import MeaningLoader
from backend.astrology.core_astrology.planetary_positions import (
    calculate_planet_positions,
    get_moon_sign,
    degree_to_sign,
)
from backend.astrology.core_astrology.aspects import calculate_aspects
from backend.astrology.core_astrology.houses import assign_planets_to_houses
from backend.astrology.core_astrology.constants import ZODIAC_ELEMENTS, ZODIAC_MODALITIES
...
def generate_birth_chart(
    ...
    try:
       ...
       # Inside generate_birth_chart function
        loader = MeaningLoader(base_dir="/media/jeff/numy/numerology_ai/backend/astrology/astro_data/meanings")
        sun_data = {
